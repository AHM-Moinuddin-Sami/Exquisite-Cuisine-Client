...
const Footer = () => {
    ...
    return (
        <footer className="footer footer-center p-10 bg-gradient-to-r from-red-700 via-orange-700 to-red-700 text-primary-content">
            <div>
                ...
                <p className="font-bold">
                    Exquisite Quisine Inc.
                </p>
                <div>
                    <p className='mb-2'>Subscribe to our Newsletter</p>
                    <input className='px-5 py-2 rounded border-white' type="email" name="" id="" placeholder='example@mail.com' />
                    <button className='px-6 py-2 bg-gradient-to-b from-red-500 to-orange-500 hover:from-red-600 active:from-red-800 hover:to-orange-600 active:to-orange-800 rounded text-white ml-2'>Subscribe</button>
                </div>
